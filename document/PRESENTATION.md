...
> **수치 기준일:** 2026-08-07 (실제 `./gradlew test` · `npm run test:run` 실행 결과)
...
## 22. 테스트 결과 (2026-08-07 실측)

| 구분 | 개수 | 상태 |
|---|---:|---|
| 백엔드 (JUnit 5 + Mockito) | **269** | ✅ 전부 통과 |
| 프론트엔드 (Vitest + Testing Library) | **104** | ✅ 전부 통과 |
| E2E 스모크 (Playwright) | **5** | ✅ 전부 통과 |
| **합계** | **378** | |
...
| 지표 | 수치 |
|---|---|
| 라인 | **98%** (1,054줄 중 22줄 미커버) |
| 브랜치 | **87%** (165개 중 21개 미커버) |
...
단위 테스트 373개가 전부 통과해도 **못 잡는 것**이 있습니다:
