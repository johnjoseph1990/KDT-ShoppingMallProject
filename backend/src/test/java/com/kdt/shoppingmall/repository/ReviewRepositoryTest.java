...
class ReviewRepositoryTest {
    ...
    void existsByMemberIdAndProductId_존재하면_true() {
        ...
        assertThat(reviewRepository.existsByMemberIdAndProductId(member.getId(), product.getId())).isTrue();
    }

    @Test
    void existsByMemberIdAndProductId_없으면_false() {
        assertThat(reviewRepository.existsByMemberIdAndProductId(member.getId(), product.getId())).isFalse();
    }
}
